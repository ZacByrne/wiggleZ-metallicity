...
*-
      ...
      INTEGER OUTFIL1, OUTFIL2, OUTFIL3, OUTFIL0
     ...
     :     OUTFIL0=20, SPFIL1=14, SPFIL2=16, SPFIL3=18,  
     :     MAXSIZ=8000, MP=40, NP=40)
      ...
      CHARACTER*40 ONAME, TNAME, FILNAM
...
C Hbeta = 4861.3 + 4861.3
	...
	WRITE(OUTFIL2,'(A10,I7,5F9.2,I7,2F9.2,2F9.5,7F9.2
	 ...
	 WRITE(OUTFIL5,'(A10,10F9.2)')
	      TNAME,OWF,OWE,OIIF,OIIE,OIIIF,OIIIE,HBF,HBE,HGF,HGAE
